...
class ReBuilding(models.Model):
    ...
    owner_id = fields.Many2one('res.partner', string="Propriétaire", domain="[('is_property_owner', '=', True)]")
    ...
    expected_monthly_revenue = fields.Monetary(string="Revenu mensuel attendu", compute='_compute_expected_revenue')
